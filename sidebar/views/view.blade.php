<div class="devTools-sidebar open">
    <a class="devTools-btn-toggle" href="#"><i class="fad fa-cogs"></i></a>
    <div class="devTools-sidebar-body">
        <div class="devTools-header p-3">
            <div class="d-flex align-items-center justify-content-between">
                <h4 class="text-uppercase mb-2 text-lg fw-bold">DEV TOOL</h4>
                <div class="devTools-theme">
            ...
            <div class="d-flex">
                ...
                {!! Admin::button('blue', [
                    ...
                    'tooltip'   => 'Chế độ tối',
                    'class'     => ['p-1', 'devTools-theme-dark'],
                    'style'     => ['font-size' => '18px;']
                ]) !!}
                {!! Admin::button('white', [
                    'icon'      => '<i class="fa-duotone fa-cloud-sun"></i>',
                    'tooltip'   => 'Chế độ sáng',
                    'class'     => ['p-1', 'devTools-theme-light'],
                    'style'     => ['font-size' => '18px;']
                ]) !!}
            </div>
        </div>
        ...
        <div class="">
            <div class="tab-content" id="devTools-tabs-content">
                <div class="tab-pane fade show active" id="devTools-tab-layout" role="tabpanel" tabindex="0">
                ...
                <div class="tab-pane fade" id="devTools-tab-hook" role="tabpanel" tabindex="0">
                    @include('DevTool.sidebar.views.hooks', ['globalFilter' => $globalFilter, 'listHook' => $listHook])
                </div>
                <div class="tab-pane fade" id="devTools-tab-debug" role="tabpanel" tabindex="0">
                    {!! $debugBar !!}
                </div>
            </div>
        </div>
